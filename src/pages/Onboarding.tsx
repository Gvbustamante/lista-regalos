  ...
  return (
    <div className="grid min-h-dvh place-items-center bg-gradient-to-br from-mint to-mint-soft p-4">
      <form onSubmit={submit} className="grid w-full max-w-md gap-4 rounded-3xl bg-white p-8 shadow-xl">
        <h1 className="text-3xl font-black text-brand">Crea tu parque 🛝</h1>
        ...
        <button disabled={busy || !name.trim()} className="rounded-2xl bg-brand py-4 text-xl font-black text-white disabled:opacity-50">Comenzar</button>
